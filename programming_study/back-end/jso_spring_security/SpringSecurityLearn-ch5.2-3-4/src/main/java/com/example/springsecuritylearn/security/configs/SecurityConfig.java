...
public class SecurityConfig {
    ...
    @Autowired
    private void setSecurityConfig(AuthenticationConfiguration authenticationConfiguration,
                                   FormWebAuthenticationDetailsSource formWebAuthenticationDetailsSource,
